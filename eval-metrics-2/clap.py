...
GEN_DIR = "../shared/data/lmd_full_testset_first_3k"
...
if __name__ == "__main__":
    ...
    for sd in subdirs:
        ...
        subdir_path_mp3 = os.path.join("../shared/data/lmd_full_testset_first_3k_mp3", sd)
        print(subdir_path_mp3)
        subdir_path = os.path.join(GEN_DIR, sd)

        audio_files = glob.glob("../shared/data/lmd_full_testset_first_3k_mp3/" + sd + ".mp3")
